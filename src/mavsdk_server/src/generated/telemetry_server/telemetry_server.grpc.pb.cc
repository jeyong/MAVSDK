...
static const char* TelemetryServerService_method_names[] = {
  ...
  "/mavsdk.rpc.telemetry_server.TelemetryServerService/PublishSubakInfo",
};
...
TelemetryServerService::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel, const ::grpc::StubOptions& options)
  ...
  , rpcmethod_PublishSubakInfo_(TelemetryServerService_method_names[14], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  {}
...
::grpc::Status TelemetryServerService::Stub::PublishSubakInfo(::grpc::ClientContext* context, const ::mavsdk::rpc::telemetry_server::PublishSubakInfoRequest& request, ::mavsdk::rpc::telemetry_server::PublishSubakInfoResponse* response) {
  return ::grpc::internal::BlockingUnaryCall< ::mavsdk::rpc::telemetry_server::PublishSubakInfoRequest, ::mavsdk::rpc::telemetry_server::PublishSubakInfoResponse, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), rpcmethod_PublishSubakInfo_, context, request, response);
}

void TelemetryServerService::Stub::async::PublishSubakInfo(::grpc::ClientContext* context, const ::mavsdk::rpc::telemetry_server::PublishSubakInfoRequest* request, ::mavsdk::rpc::telemetry_server::PublishSubakInfoResponse* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall< ::mavsdk::rpc::telemetry_server::PublishSubakInfoRequest, ::mavsdk::rpc::telemetry_server::PublishSubakInfoResponse, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_PublishSubakInfo_, context, request, response, std::move(f));
}

void TelemetryServerService::Stub::async::PublishSubakInfo(::grpc::ClientContext* context, const ::mavsdk::rpc::telemetry_server::PublishSubakInfoRequest* request, ::mavsdk::rpc::telemetry_server::PublishSubakInfoResponse* response, ::grpc::ClientUnaryReactor* reactor) {
  ::grpc::internal::ClientCallbackUnaryFactory::Create< ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_PublishSubakInfo_, context, request, response, reactor);
}

::grpc::ClientAsyncResponseReader< ::mavsdk::rpc::telemetry_server::PublishSubakInfoResponse>* TelemetryServerService::Stub::PrepareAsyncPublishSubakInfoRaw(::grpc::ClientContext* context, const ::mavsdk::rpc::telemetry_server::PublishSubakInfoRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderHelper::Create< ::mavsdk::rpc::telemetry_server::PublishSubakInfoResponse, ::mavsdk::rpc::telemetry_server::PublishSubakInfoRequest, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), cq, rpcmethod_PublishSubakInfo_, context, request);
}

::grpc::ClientAsyncResponseReader< ::mavsdk::rpc::telemetry_server::PublishSubakInfoResponse>* TelemetryServerService::Stub::AsyncPublishSubakInfoRaw(::grpc::ClientContext* context, const ::mavsdk::rpc::telemetry_server::PublishSubakInfoRequest& request, ::grpc::CompletionQueue* cq) {
  auto* result =
    this->PrepareAsyncPublishSubakInfoRaw(context, request, cq);
  result->StartCall();
  return result;
}
...
TelemetryServerService::Service::Service() {
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< TelemetryServerService::Service, ::mavsdk::rpc::telemetry_server::PublishSubakInfoRequest, ::mavsdk::rpc::telemetry_server::PublishSubakInfoResponse, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(
          [](TelemetryServerService::Service* service,
             ::grpc::ServerContext* ctx,
             const ::mavsdk::rpc::telemetry_server::PublishSubakInfoRequest* req,
             ::mavsdk::rpc::telemetry_server::PublishSubakInfoResponse* resp) {
               return service->PublishSubakInfo(ctx, req, resp);
             }, this)));
}
...
::grpc::Status TelemetryServerService::Service::PublishSubakInfo(::grpc::ServerContext* context, const ::mavsdk::rpc::telemetry_server::PublishSubakInfoRequest* request, ::mavsdk::rpc::telemetry_server::PublishSubakInfoResponse* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
