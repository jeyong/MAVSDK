...
static const char* TelemetryService_method_names[] = {
  ...
  "/mavsdk.rpc.telemetry.TelemetryService/SubscribeSubakInfo",
...
TelemetryService::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel, const ::grpc::StubOptions& options)
  ...
  , rpcmethod_SubscribeSubakInfo_(TelemetryService_method_names[33], options.suffix_for_stats(),::grpc::internal::RpcMethod::SERVER_STREAMING, channel)
  ...
  , rpcmethod_SetRateAttitude_(TelemetryService_method_names[39], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
...
::grpc::ClientReader< ::mavsdk::rpc::telemetry::SubakInfoResponse>* TelemetryService::Stub::SubscribeSubakInfoRaw(::grpc::ClientContext* context, const ::mavsdk::rpc::telemetry::SubscribeSubakInfoRequest& request) {
  return ::grpc::internal::ClientReaderFactory< ::mavsdk::rpc::telemetry::SubakInfoResponse>::Create(channel_.get(), rpcmethod_SubscribeSubakInfo_, context, request);
}

void TelemetryService::Stub::async::SubscribeSubakInfo(::grpc::ClientContext* context, const ::mavsdk::rpc::telemetry::SubscribeSubakInfoRequest* request, ::grpc::ClientReadReactor< ::mavsdk::rpc::telemetry::SubakInfoResponse>* reactor) {
  ::grpc::internal::ClientCallbackReaderFactory< ::mavsdk::rpc::telemetry::SubakInfoResponse>::Create(stub_->channel_.get(), stub_->rpcmethod_SubscribeSubakInfo_, context, request, reactor);
}

::grpc::ClientAsyncReader< ::mavsdk::rpc::telemetry::SubakInfoResponse>* TelemetryService::Stub::AsyncSubscribeSubakInfoRaw(::grpc::ClientContext* context, const ::mavsdk::rpc::telemetry::SubscribeSubakInfoRequest& request, ::grpc::CompletionQueue* cq, void* tag) {
  return ::grpc::internal::ClientAsyncReaderFactory< ::mavsdk::rpc::telemetry::SubakInfoResponse>::Create(channel_.get(), cq, rpcmethod_SubscribeSubakInfo_, context, request, true, tag);
}

::grpc::ClientAsyncReader< ::mavsdk::rpc::telemetry::SubakInfoResponse>* TelemetryService::Stub::PrepareAsyncSubscribeSubakInfoRaw(::grpc::ClientContext* context, const ::mavsdk::rpc::telemetry::SubscribeSubakInfoRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncReaderFactory< ::mavsdk::rpc::telemetry::SubakInfoResponse>::Create(channel_.get(), cq, rpcmethod_SubscribeSubakInfo_, context, request, false, nullptr);
}
...
TelemetryService::Service::Service() {
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      ::grpc::internal::RpcMethod::SERVER_STREAMING,
      new ::grpc::internal::ServerStreamingHandler< TelemetryService::Service, ::mavsdk::rpc::telemetry::SubscribeSubakInfoRequest, ::mavsdk::rpc::telemetry::SubakInfoResponse>(
          [](TelemetryService::Service* service,
             ::grpc::ServerContext* ctx,
             const ::mavsdk::rpc::telemetry::SubscribeSubakInfoRequest* req,
             ::grpc::ServerWriter<::mavsdk::rpc::telemetry::SubakInfoResponse>* writer) {
               return service->SubscribeSubakInfo(ctx, req, writer);
             }, this)));
  AddMethod(new ::grpc::internal::RpcServiceMethod(
...
::grpc::Status TelemetryService::Service::SubscribeSubakInfo(::grpc::ServerContext* context, const ::mavsdk::rpc::telemetry::SubscribeSubakInfoRequest* request, ::grpc::ServerWriter< ::mavsdk::rpc::telemetry::SubakInfoResponse>* writer) {
  (void) context;
  (void) request;
  (void) writer;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
