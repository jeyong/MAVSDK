...
public:
    ...
    static std::unique_ptr<rpc::telemetry::SubakInfo> translateToRpcSubakInfo(const mavsdk::Telemetry::SubakInfo &subak_info)
    {
        auto rpc_obj = std::make_unique<rpc::telemetry::SubakInfo>();


            
        rpc_obj->set_x_value(subak_info.x_value);
            
        
            
        rpc_obj->set_y_value(subak_info.y_value);
    ...
    static mavsdk::Telemetry::SubakInfo translateFromRpcSubakInfo(const rpc::telemetry::SubakInfo& subak_info)
    {
        mavsdk::Telemetry::SubakInfo obj;


            
        obj.x_value = subak_info.x_value();
            
        
            
        obj.y_value = subak_info.y_value();
    ...
    grpc::Status SubscribeSubakInfo(grpc::ServerContext* /* context */, const mavsdk::rpc::telemetry::SubscribeSubakInfoRequest* /* request */, grpc::ServerWriter<rpc::telemetry::SubakInfoResponse>* writer) override
    {
        if (_lazy_plugin.maybe_plugin() == nullptr) {
        ...
        _lazy_plugin.maybe_plugin()->subscribe_subak_info(
            [this, &writer, &stream_closed_promise, is_finished, subscribe_mutex](const mavsdk::Telemetry::SubakInfo subak_info) {

            rpc::telemetry::SubakInfoResponse rpc_response;
        
            rpc_response.set_allocated_subak_info(translateToRpcSubakInfo(subak_info).release());
            ...
            if (!*is_finished && !writer->Write(rpc_response)) {
                ...
                _lazy_plugin.maybe_plugin()->subscribe_subak_info(nullptr);
