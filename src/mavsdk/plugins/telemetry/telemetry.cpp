...
using SubakInfo = Telemetry::SubakInfo;
...
void Telemetry::subscribe_subak_info(SubakInfoCallback callback)
{
    _impl->subscribe_subak_info(callback);
}
...
Telemetry::SubakInfo
Telemetry::subak_info() const
{
    return _impl->subak_info();
}
...
bool operator==(const Telemetry::SubakInfo& lhs, const Telemetry::SubakInfo& rhs)
{
    return
...
std::ostream& operator<<(std::ostream& str, Telemetry::SubakInfo const& subak_info)
{
    str << std::setprecision(15);
    str << "subak_info:" << '\n'
        << "{\n";
