...
using SubakInfo = TelemetryServer::SubakInfo;
...
TelemetryServer::Result TelemetryServer::publish_subak_info(SubakInfo subak_info) const
{
    return _impl->publish_subak_info(subak_info);
}
...
bool operator==(const TelemetryServer::SubakInfo& lhs, const TelemetryServer::SubakInfo& rhs)
{
    return
        ((std::isnan(rhs.x_value) && std::isnan(lhs.x_value)) || rhs.x_value == lhs.x_value) &&
        ((std::isnan(rhs.y_value) && std::isnan(lhs.y_value)) || rhs.y_value == lhs.y_value);
}

std::ostream& operator<<(std::ostream& str, TelemetryServer::SubakInfo const& subak_info)
{
    str << std::setprecision(15);
    str << "subak_info:" << '\n'
        << "{\n";
    str << "    x_value: " << subak_info.x_value << '\n';
    str << "    y_value: " << subak_info.y_value << '\n';
    str << '}';
    return str;
}
