...
public:
    ...
    /**
     * @brief Equal operator to compare two `TelemetryServer::SubakInfo` objects.
     *
     * @return `true` if items are equal.
     */
    friend bool operator==(const TelemetryServer::SubakInfo& lhs, const TelemetryServer::SubakInfo& rhs);

    /**
     * @brief Stream operator to print information about a `TelemetryServer::SubakInfo`.
     *
     * @return A reference to the stream.
     */
    friend std::ostream& operator<<(std::ostream& str, TelemetryServer::SubakInfo const& subak_info);
    ...
    /**
     * @brief Publish to 'Subak Info' updates.
     *
     * This function is blocking.
     *
     * @return Result of request.
     */
    Result publish_subak_info(SubakInfo subak_info) const;
